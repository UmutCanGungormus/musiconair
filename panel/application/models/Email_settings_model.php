...
class Email_settings_model extends CI_Model
{
	...
	{
		parent::__construct();
		$this->column_order = array('rank', 'id', 'id', 'user_name','user', 'host','createdAt','updatedAt','isActive');
        // Set searchable column fields
        $this->column_search = array('rank', 'id', 'id', 'user_name','user', 'host','createdAt','updatedAt', 'isActive');
        // Set default order
