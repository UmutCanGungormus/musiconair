...
class Emailsettings extends MY_Controller
{
        ...
        foreach ($items as $item) {
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu rounded-0 dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item remove-btn" href="javascript:void(0)" data-url="' . base_url("emailsettings/delete/$item->id") . '"><i class="fa fa-trash mr-2"></i>Kaydı Sil</a>
                    </div>
            </div>';
    ...
    public function save()
    {
        ...
        if ($validate) {
            $insert = $this->email_settings_model->add(
                array(
    ...
    public function update($id)
    {
        ...
        $validate = $this->form_validation->run();
        if ($validate) {
            $update = $this->email_settings_model->update(
                array("id" => $id),
                array(
                    "protocol"      => $this->input->post("protocol"),
                    "host"          => $this->input->post("host"),
