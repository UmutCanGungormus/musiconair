                ...
                <div class="widget-body">
                    <form action="<?= base_url("product/update/$item->id"); ?>" method="post">
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-sm rounded-0" placeholder="Ürün Adı" name="title" value="<?= $item->title; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0.00" max="10000.00" step="0.10" value="<?= $item->price?>"class="form-control form-control-sm rounded-0" placeholder="Ürün Fiyatı" name="price">
                            <?php if (isset($form_error)) : ?>
