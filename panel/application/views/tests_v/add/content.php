...
<form id="createTest" onsubmit="return false" method="post" enctype="multipart/form-data">
    ...
    <button role="button" data-url="<?= base_url("test/save"); ?>" class="btn btn-sm btn-outline-primary rounded-0 btnSave">Kaydet</button>
