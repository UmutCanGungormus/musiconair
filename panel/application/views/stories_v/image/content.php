...
<div class="container-fluid mt-xl-50 mt-lg-30 mt-15 bg-white p-3">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <form data-table="detailTable" action="<?= base_url("stories/file_upload/$item->id/$item->folder_name"); ?>" id="dropzone" class="dropzone" data-plugin="dropzone" data-options="{ url: '<?= base_url("stories/file_upload/$item->id/$item->folder_name"); ?>'}">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <script>
				...
				$(document).ready(function() {
					TableInitializerV2("detailTable", obj, {}, "<?= base_url("stories/detailDatatable/{$item->folder_name}") ?>", "<?= base_url("stories/fileRankSetter/") ?>", true);
