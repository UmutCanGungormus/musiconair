                    ...
                    <form action="<?= base_url("portfolio/update/$item->id"); ?>" method="post">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Başlık</label>
                                <input class="form-control form-control-sm rounded-0" placeholder="İşi anlatan başlık bilgisi" name="title" value="<?= (isset($form_error)) ? set_value("title") : $item->title; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Müşteri</label>
                                            <input class="form-control form-control-sm rounded-0" placeholder="İşi yaptığınız müşteri" name="client" value="<?= (isset($form_error)) ? set_value("client") : $item->client; ?>">
                                            <?php if (isset($form_error)) : ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm rounded-0" placeholder="İşi yaptığınız Yer/Mekan bilgisi" name="place" value="<?= (isset($form_error)) ? set_value("place") : $item->place; ?>">
                                            <?php if (isset($form_error)) : ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm rounded-0" placeholder="Yapılan işin internet üzerindeki bağlantısı" name="portfolio_url" value="<?= (isset($form_error)) ? set_value("portfolio_url") : $item->portfolio_url; ?>">
                                            <?php if (isset($form_error)) : ?>
