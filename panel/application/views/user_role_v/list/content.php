	...
	<div class="row">
		<div class="col-md-12">
			<h4 class="mb-3">
				...
				<a href="<?= base_url("user_role/new_form"); ?>" class="float-right btn btn-sm btn-outline-primary rounded-0 btn-sm"><i class="fa fa-plus"></i>Yeni Ekle</a>
			</h4>
		</div><!-- END column -->
		<div class="col-md-12">
			<div class="widget p-lg">
				<?php if (empty($items)) : ?>
					<div class="alert alert-info text-center">
						...
						<p>Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a href="<?= base_url("user_role/new_form"); ?>">tıklayınız...</a></p>
					</div>
				<?php else : ?>
