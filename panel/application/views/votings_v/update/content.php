...
<form id="updateVoting" onsubmit="return false" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-3 image_upload_container">
            <img src="<?= get_picture($viewFolder, $item->img_url); ?>" alt="<?=$item->title?>" class="img-fluid">
        </div>
        <div class="col-9">
    ...
    <button role="button" data-url="<?= base_url("votings/update/{$item->id}"); ?>" class="btn btn-sm btn-outline-primary rounded-0 btnUpdate">Güncelle</button>
