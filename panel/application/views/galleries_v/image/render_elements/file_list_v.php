    ...
    <tbody class="sortable" data-url="<?php echo base_url("galleries/fileRankSetter/$gallery_type"); ?>">
        <?php foreach ($items as $item) { ?>
            <tr id="ord-<?php echo $item->id; ?>">
                ...
                <td class="w100 text-center">
                    <a href="<?php echo base_url("galleries/fileUpdate/$item->id/$item->gallery_id/$gallery_type"); ?>" class="btn btn-sm btn-sm btn-outline-success rounded-0   btn-block">
                        <i class="fa fa-pen"></i> Resim Açıklama Ekle
                    </a>
                </td>
                <td class="w100 text-center">
                    <button data-url="<?php echo base_url("galleries/fileDelete/$item->id/$item->gallery_id/$gallery_type"); ?>" class="btn btn-sm btn-sm btn-outline-danger rounded-0 remove-btn btn-sm btn-block">
