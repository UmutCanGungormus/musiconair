<?php
$haber = $this->db->query("select * from site_news WHERE id=$song->haber_id")->row();
$yazar = $this->db->query("select * from site_writers where id=$haber->yazar_id")->row();
$this->db->query("update site_songs set goruntulenme=(goruntulenme+1) where id=$song->id");
$comments = $this->db->query("select * from site_comments where iliski_tip='müzik' and iliski_id=$haber->id ORDER BY tarih")->result();
?>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 my-3">
                <div class="container breadcrumb p-0">
                    ...
                    <b><a href="<?php echo base_url("muzik");?>">Müzikler</a></b> >
                    <b><a href="#"><?php echo $haber->baslik; ?></a> </b>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    <form method="post" action="#" enctype="multipart/form-data">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalBaslik">Bildirim Formu</h5>
                        </div>
                ...
                <div class="col-md-1 text-center">
                    <div class="position-fixed">
                        ...
                        <div class="mt-2 ml-1 text-center">
                            <b class="d-block"><?php echo $song->goruntulenme; ?></b>
                        ...
                        <div class="mt-2">
                            <div class="ml-3">
                                ...
                                <div style="background-color: #00acee; width: 40px; border-bottom-left-radius: 30px; border-bottom-right-radius: 30px; padding: 10px;">
                                    <a href="http://twitter.com/share?text=<?php echo $haber->baslik ?>&url=<?php echo "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF'] ?>"
                                       target="_blank">
                                ...
                                document.addEventListener("DOMContentLoaded", function () {
                                    ...
                                    addFav.click(function () {
                                        $.ajax({
                                            url: urlAdd,
                                            method: "POST",
                                            data: {ad: baslik, haberid: haberId, user: user, url: url},
                            ...
                            <div class="container px-0">
                                ...
                                if ($haber->video_goster) {
                                    ...
                                    <div class="video-detail-video p-2 bg-light clearfix">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-4">
                                                <h5><b>Çıkış Yılı</b>: <?php echo date("Y",strtotime($song->cikis_tarih));?></h5>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>Yapımcı</b>: <?php echo $song->yapimci;?></h5>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>Albüm & Single</b>: <?php echo $song->ad;?></h5>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>

                                <h3 class="mt-3"><?php echo $haber->baslik;?></h3>
                                <div class="mt-2">
                                        ...
                                        <li class="list-group-item bg-transparent">
                                            <div style="width: 35px; height: 35px; overflow: hidden; border-radius: 35px; float: left;">
                                                <img style="height: 35px!important;"
                                                     ...
                                                     alt="<?php echo $item->baslik ?>">
                                            </div>
                                            <a href="<?php echo base_url("haber_detay/" . $item->id); ?>"
                                               class="d-inline-block mt-2 float-right text-color"><?php echo $item->baslik; ?></a>
                                        </li>
