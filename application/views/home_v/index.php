...
<div class="container-fluid px-0 pr-0 mt-5">
  ...
  <img width="100%" src="<?php echo base_url("panel/uploads/slides_v/857x505/");?><?php echo $slide->img_url?>" alt="...">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">İleri</span>
            ...
            <div class="col-md-4">
                <div class="row">
                    <?php
                        foreach (home_page_banner() as $banner){?>
                            <div class="col-md-12 mb-1"> 
                                    <a href="<?php echo $banner->url?>"> 
                                        <img src="<?php echo base_url("panel/uploads/home_banner_v/857x505/");?><?php echo $banner->img_url?>">
                                    </a>    
                                </div>  
                        <?php  }
                    ?>
            ...
            <div class="container p-0 ">
                ...
                <div class="owl-carousel owl-trends owl-theme mt-3">
                    ...
                    <?php foreach ($news as $haber) {
                        ...
                        ?>
                        <a target="_blank" href="<?php echo base_url("haber/".$haber->seo_url);?>">
                            <div class="card item mb-3 dark shadow-none">
                                <div class="card-body p-0 m-0">
                                    <div style="position: relative; height:250px;">
                                        <img  style="max-height:220px;" src="<?php echo base_url("panel/uploads/news_v/370x297/".$haber->img_url); ?>"
                                             class="img-fluid">
                                        <i class="<?php echo $haber->emoji?>"></i>
                                    </div>

                                    <div style="font-size: 11px;">
                                        <div class="d-inline-block mr-1 py-2 px-2">
                                            <i class="fa fa-user"></i> &nbsp; <?php echo get_writer($haber->writer_id)->name?>
                                        </div>
                                        <div class="d-inline-block">
                                            <i class="fa fa-clock-o mr-1" style="font-size: 11px;"></i><?php echo date("d/m/Y",strtotime($haber->date));  ?>
                                        </div>
                                    </div>
