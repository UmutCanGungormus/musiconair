    ...
    <div class="container-fluid mt-3">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-3">
                <div class="breadcrumb pl-0">
                    ...
                    <a href="<?= base_url("is-ilanlari") ?>">İş İlanları</a> <span>></span>
                    <a href="javascript:void(0)"><?= $job_advertisement->title; ?></a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
                ...
                <h2 class="mt-1"><?= $job_advertisement->title; ?></h2>
                <span class="grey-text d-inline-flex align-middle"><i class="fa fa-clock-o mr-1 my-auto"></i> Yayınlanma Tarihi: <?= turkishDate("d F Y, l H:i", $job_advertisement->createdAt) ?></span>
                <?php if ($job_advertisement->updatedAt) : ?>
                    <span class="grey-text ml-2 d-inline-flex align-middle"><i class="fa fa-clock-o mr-1 my-auto"></i> Güncellenme Tarihi: <?= turkishDate("d F Y, l H:i", $job_advertisement->updatedAt) ?></span>
                <?php endif; ?>
                <?php if ($job_advertisement->img_url) : ?>
                    <img src="<?= get_picture("job_advertisements_v", $job_advertisement->img_url) ?>" class="img-fluid w-100 my-3" alt="<?= $job_advertisement->title ?>">
                <?php endif; ?>
                    ...
                    <div class="justify-content-start flex-shrink-1">
                        <ul class="list-group px-auto mx-auto justify-content-center text-center w-100 d-flex">
                            <li class="list-group-item p-3 mx-auto justify-content-center text-center w-100 radius-secondary mb-1">
                                <a class="mx-auto px-auto justify-content-center text-center w-100 text-white" href="javascript:void(0)"><?= clean($job_advertisement->hit); ?></a>
                            </li>
                            <li class="list-group-item p-3 mx-auto justify-content-center text-center w-100 radius-facebook">
                                <a class="mx-auto px-auto justify-content-center text-center w-100 text-white" href="https://www.facebook.com/sharer/sharer.php?u=<?= base_url("is-ilani/{$job_advertisement->seo_url}") ?>" target="_blank">
                            ...
                            <li class="list-group-item p-3 mx-auto justify-content-center text-center w-100 radius-twitter mb-1">
                                <a class="mx-auto px-auto justify-content-center text-center w-100 text-white" href="http://twitter.com/share?text=<?= $job_advertisement->title ?>&url=<?= base_url("is-ilani/{$job_advertisement->seo_url}") ?>" target="_blank">
                            ...
                            <li class="list-group-item p-3 mx-auto justify-content-center text-center w-100 radius-secondary mb-1">
                                <a href="javascript:void(0)" class="btnCopyLink mx-auto px-auto justify-content-center text-center w-100 text-white" data-clipboard-text="<?= base_url($job_advertisement->seo_url) ?>">
                ...
                <div class="mt-4">
                    <b>Etiketler</b>
                    <?php $tags = explode(",", $job_advertisement->education_level); ?>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                ...
                <h3 class="title">Benzer İş İlanları</h3>
                <?php if (!empty($similar)) : ?>
                    <?php foreach ($similar as $item) : ?>
                        <a href="<?= base_url("is-ilani/" . $item->seo_url); ?>" class="text-color">
