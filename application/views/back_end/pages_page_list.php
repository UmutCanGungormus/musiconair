<div id="content">
    <div id="content-header">
        ...
        <p style="margin: 0px 20px;">Eklenen sayfa sayısı: <b><?php echo count($get_pages); ?></b></p>
    </div>
    <!-- content-header -->
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered">
                            ...
                            <?php foreach ($get_pages as $value): ?>
                                ...
                                <tr <?php if ($value -> page_status == 0) echo 'bgcolor="f2dede"'; ?>>
                                    ...
                                    <td><?php echo $value -> page_template_name; ?>
                                    <td><?php echo $value -> page_group_name; ?>
                                    </td>
                                    ...
                                    <td class="center">
                                        <a href="#Delete<?php echo $value -> page_id; ?>" data-toggle="modal" class="btn-danger">
