<div id="content">
    <div id="content-header">
        ...
        <p style="margin: 0px 20px;">Eklenen sayfa sayısı: <b><?php echo count($albumler); ?></b></p>
    </div>
    <!-- content-header -->
    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo base_url('yonetici/unlu-yonetimi/album-ekle'); ?>" class="btn-success" style="float: right;">
            <i class="icon-plus"></i> ALBÜM & SİNGLE EKLE
        </a>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <?php foreach ($albumler as $value): ?>
                          
                                <tr>
                                    <td style="text-align: center;"><?php echo $value ->id ?></td>
                                    <td><?php echo $value ->ad ?></td>
                                    <td><?php $sanatci= $this->db->query("select * from site_artists 
                                    WHERE id=$value->sanatci_id")->row();
                                    echo $sanatci->ad;
                                    ?></td>
                                    <td>
                                        <?php $haber= $this->db->query("select * from site_news 
                                        where id=$value->haber_id")->row();
                                        echo $haber->baslik;
                                        ?>
                                    </td>
                                    <td>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url('yonetici/unlu-yonetimi/album-duzenle/'.$value -> id); ?>" class="btn-success">
                                ...
                                <div id="Delete<?php echo $value -> id; ?>" class="modal hide">
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-primary" href="<?php echo base_url('yonetici/unlu-yonetimi/album-sil/'.$value -> id); ?>">Sil</a>
