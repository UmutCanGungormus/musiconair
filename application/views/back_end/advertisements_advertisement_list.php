<div id="content">
    <div id="content-header">
        ...
        <p style="margin: 0px 20px;">Eklenen sayfa sayısı: <b><?php echo count($get_advertisements); ?></b></p>
    </div>
    <!-- content-header -->
    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo base_url('yonetici/ilan-yonetimi/ilan-ekle'); ?>" class="btn-success" style="float: right;">
            <i class="icon-plus"></i> İLAN EKLE
        </a>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th width="90">BAŞVURU</th>
                                    <th width="80">DÜZENLE</th>
                                    <th width="55">SİL</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php foreach ($get_advertisements as $value): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo  date("Y-m-d H:i:s",strtotime($value->create_date));?></td>
                                    <td><?php $app= $this->db->query("select count(*) as 'sayi' from site_application WHERE advertisement_id=$value->id")->row_array();
                                    echo $app['sayi'];?></td>
                                    <td class="center">
                                        <a href="<?php echo base_url('yonetici/ilan-yonetimi/ilan-duzenle/'.$value -> id); ?>" class="btn-success">
                                ...
                                <div id="Delete<?php echo $value -> id; ?>" class="modal hide">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <h4><?php echo $value ->company; ?></h4>
                                    </div>
                                    <!-- modal-body -->

                                    <div class="modal-footer">
                                        <a class="btn btn-primary" href="<?php echo base_url('yonetici/ilan-yonetimi/ilan-sil/'.$value -> id); ?>">Sil</a>
