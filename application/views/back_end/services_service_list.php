<div id="content">
    <div id="content-header">
        ...
        <p style="margin: 0px 20px;">Eklenen hizmet sayısı: <b><?php echo count($get_services); ?></b></p>
    </div>
    <!-- content-header -->
    ...
    <div class="container-fluid">
        ...
        <form method="get" action="<?php echo base_url('yonetici/hizmet-yonetimi/hizmet-ara'); ?>">
            <input type="text" name="kelime" class="span8" style="float: left;" placeholder="Hizmet adı" required="" />
        </form>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <?php foreach ($get_services as $value): ?>
