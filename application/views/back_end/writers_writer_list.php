<div id="content">
    <div id="content-header">
        ...
        <p style="margin: 0px 20px;">Eklenen sayfa sayısı: <b><?php echo count($get_writers); ?></b></p>
    </div>
    <!-- content-header -->
    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo base_url('yonetici/yazar-yonetimi/yazar-ekle'); ?>" class="btn-success" style="float: right;">
            <i class="icon-plus"></i> YAZAR EKLE
        </a>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <?php foreach ($get_writers as $value): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url('yonetici/yazar-yonetimi/yazar-duzenle/'.$value -> id); ?>" class="btn-success">
                                ...
                                <div id="Delete<?php echo $value -> id; ?>" class="modal hide">
                                    ...
                                    <div class="modal-body">
                                        <p>Bu yazaryi silmek istediğinize emin misiniz?</p>
                                        <h4><?php echo $value ->nick; ?></h4>
                                    </div>
                                    <!-- modal-body -->

                                    <div class="modal-footer">
                                        <a class="btn btn-primary" href="<?php echo base_url('yonetici/yazar-yonetimi/yazar-sil/'.$value -> id); ?>">Sil</a>
