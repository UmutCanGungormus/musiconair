<div id="content">
    <div id="content-header">
        ...
        <p style="margin: 0px 20px;">Eklenen galeri sayısı: <b><?php echo count($get_galleries); ?></b></p>
    </div>
    <!-- content-header -->
        ...
        <?php
            if (@$_GET['addAction'] == 'true'):
                echo '<div class="alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
                 ...
                 Galeri ekleme işlemi başarılı.</div>';
            elseif (@$_GET['addAction'] == 'false'):
                echo '<div class="alert alert-error alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
                  <h4 class="alert-heading">Hata!</h4>
                 Galeri ekleme işlemi yapılıken bir hata oluştu. Lütfen tekrar deneyin.</div>';
            endif;

            if (@$_GET['deleteAction'] == 'true'):
                echo '<div class="alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
                  <h4 class="alert-heading">Başarılı!</h4>
                 Galeri silme işlemi başarılı.</div>';
            elseif (@$_GET['deleteAction'] == 'false'):
                echo '<div class="alert alert-error alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
                  <h4 class="alert-heading">Hata!</h4>
                 Galeri silme işlemi yapılıken bir hata oluştu. Lütfen tekrar deneyin.</div>';
            endif;

            if (@$_GET['editAction'] == 'true'):
                echo '<div class="alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
                  <h4 class="alert-heading">Başarılı!</h4>
                  Galeri düzenleme işlemi başarılı.</div>';
            elseif (@$_GET['editAction'] == 'true'):
                echo '<div class="alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
                  <h4 class="alert-heading">Başarılı!</h4>
                  Galeri düzenleme işlemi başarılı.</div>';
            endif;
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr <?php if ($gallery -> gallery_status == 0) echo 'bgcolor="f2dede"'; ?>>
                                    ...
                                    <td class="center">
                                        <a href="#Delete<?php echo $gallery -> gallery_id; ?>" data-toggle="modal" class="btn-danger">
