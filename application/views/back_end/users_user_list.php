<div id="content">
    <div id="content-header">
        ...
        <p style="margin: 0px 20px;">Eklenen sayfa sayısı: <b><?php echo count($get_users); ?></b></p>
    </div>
    <!-- content-header -->
    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo base_url('yonetici/uye-yonetimi/kullanici-ekle'); ?>" class="btn-success" style="float: right;">
            <i class="icon-plus"></i> KULLANICI EKLE
        </a>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>AD/SOYAD</th>
                                    <th>MAİL</th>
                                    <th width="120">NİCKNAME</th>
                                    <th width="80">DÜZENLE</th>
                                    <th width="55">SİL</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php foreach ($get_users as $value): ?>
                          
                                <tr>
                                    <td style="text-align: center;"><?php echo $value ->id ?></td>
                                    <td><?php echo $value ->ad." / ".$value->soyad; ?></td>
                                    <td>
                                        <?php echo $value -> mail; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url('yonetici/uye-yonetimi/kullanici-duzenle/'.$value -> id); ?>" class="btn-success">
                                ...
                                <div id="Delete<?php echo $value -> id; ?>" class="modal hide">
                                    ...
                                    <div class="modal-body">
                                        <p>Bu kullaniciyi silmek istediğinize emin misiniz?</p>
                                        <h4><?php echo $value ->nick; ?></h4>
                                    </div>
                                    <!-- modal-body -->

                                    <div class="modal-footer">
                                        <a class="btn btn-primary" href="<?php echo base_url('yonetici/uye-yonetimi/kullanici-sil/'.$value -> id); ?>">Sil</a>
