                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                <label class="control-label">Fotoğraf Başlığı</label>
                                <div class="controls">
                                    <input type="text" name="baslik" class="span11" value="<?php echo $get_slider_photo -> baslik; ?>">
                                </div>
                                <!-- controls -->
                            </div>

                            <div class="control-group">
                                <label class="control-label">Fotoğraf Yazısı</label>
                                <div class="controls">
                                    <input type="text" name="yazi" class="span11" value="<?php echo $get_slider_photo -> yazi; ?>">
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
