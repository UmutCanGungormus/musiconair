                    ...
                    <div class="widget-content nopadding">
                        <form action="#" method="post"  enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="tur" placeholder="Konser" value="<?php echo $activity->tur;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="sanatci" placeholder="Sanatçı" value="<?php echo $activity->sanatci?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls" style="width: 80% !important;">
                                    <textarea name="icerik" id="icerik" class="ckeditor"><?php echo $activity->icerik;?></textarea>
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="datetime-local" id="tarih" name="tarih" value="<?php echo date('Y-m-d\TH:i:s',strtotime($activity->tarih));?>" required="">
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls" style="width: 80% !important;">
                                    <textarea name="detaylar" id="detaylar"><?php echo $activity->detaylar;?></textarea>
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls" style="width: 80% !important;">
                                    <textarea name="fiyatlar" id="fiyatlar" ><?php echo $activity->fiyatlar;?></textarea>
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="mekan" placeholder="Joly Joker" value="<?php echo $activity->mekan;?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="sehir" placeholder="İstanbul" value="<?php echo $activity->sehir;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="url" placeholder="https://www.biletix.com" value="<?php echo $activity->url;?>" required="" />
