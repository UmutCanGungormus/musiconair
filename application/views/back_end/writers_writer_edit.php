                    ...
                    <div class="widget-content nopadding">
                        <form action="#" method="post"  enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="nick" placeholder="spencer" value="<?php echo $yazar->nick;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="mission" placeholder="Onedio Editörü" value="<?php echo $yazar->gorev;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="ad" placeholder="Orhan Pamuk" value="<?php echo $yazar->ad;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="email" class="span11" name="mail" placeholder="example@domain.com" value="<?php echo $yazar->mail;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="sifre" placeholder="" value="" />
