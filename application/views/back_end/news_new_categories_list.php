<div id="content">
    <div id="content-header">
        ...
        <p style="margin: 0px 20px;">Eklenen kategori sayısı: <b><?php echo count($get_categories_news); ?></b></p>
    </div>
    <!-- content-header -->
    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo base_url('yonetici/haber-yonetimi/kategori-ekle'); ?>" class="btn-success" style="float: right;">
            <i class="icon-plus"></i> HABER KATEGORİSİ EKLE
        </a>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <?php foreach ($get_categories_news as $value): ?>
                          
                                <tr>
                                    <td style="text-align: center;"><?php echo $value ->id ?></td>
                                    <td><?php echo $value ->ad; ?></td>
                                    <td style="text-align: center">
                                        <a href="<?php echo base_url('yonetici/haber-yonetimi/kategori-duzenle/'.$value -> id); ?>" class="btn-success">
                                ...
                                <div id="Delete<?php echo $value -> id; ?>" class="modal hide">
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-primary" href="<?php echo base_url('yonetici/haber-yonetimi/kategori-sil/'.$value -> id); ?>">Sil</a>
