                    ...
                    <div class="widget-content nopadding">
                        <form action="#" method="post"  enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="nick" placeholder="Takma Ad" value="<?php echo $user->nick;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="ad" placeholder="Mehmet" value="<?php echo $user->ad;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="soyad" placeholder="Aksoy" value="<?php echo $user->soyad;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="email" class="span11" name="mail" placeholder="mail@domain.com" value="<?php echo $user->mail;?>" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="sifre" placeholder="şifre Değiştir" value=""  />
                                    <span style="cursor: help;" title="Şifre" id="example" data-content="Mevcut Şifreyi Devam Ettirmek İçin Boş Brakın" data-placement="top" data-toggle="popover">Açıkla?</span>
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
