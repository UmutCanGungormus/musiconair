                    ...
                    <div class="widget-content nopadding">
                        <form action="#" method="post"  enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="ad" placeholder="..." value="" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="yad" placeholder="..." value="" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="date" required="required" name="cikistarih" />
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="url" placeholder="https://.." value="" />
                                ...
                                <div class="controls">
                                    <select name="artist" id="artist" required="required">
                                        <?php foreach ($sanatcilar as $item) {?>
                                            <option value="<?php echo $item->id;?>"><?php echo $item->ad;?></option>
                                        <?php }?>
                                    </select>
                                ...
                                <div class="controls">
                                    <select name="haber" id="haber">
                                        <?php foreach ($haberler as $item) {?>
                                            <option value="<?php echo $item->id;?>"><?php echo $item->baslik;?></option>
                                        <?php }?>
                                    </select>
