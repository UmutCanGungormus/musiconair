<div id="content">
    <div id="content-header">
        ...
        <p style="margin: 0px 20px;">Eklenen sayfa sayısı: <b><?php echo count($get_videos); ?></b></p>
    </div>
    <!-- content-header -->
    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo base_url('yonetici/video-yonetimi/video-ekle'); ?>" class="btn-success" style="float: right;">
            <i class="icon-plus"></i> VİDEO EKLE
        </a>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <?php foreach ($get_videos as $value): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url('yonetici/video-yonetimi/video-duzenle/'.$value -> id); ?>" class="btn-success">
                                ...
                                <div id="Delete<?php echo $value -> id; ?>" class="modal hide">
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-primary" href="<?php echo base_url('yonetici/video-yonetimi/video-sil/'.$value -> id); ?>">Sil</a>
