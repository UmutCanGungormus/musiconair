                    ...
                    <div class="widget-content nopadding">
                        <form method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="service_add_name" placeholder="Hizmet Adı" value="" required="" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls" style="width: 80% !important;">
                                    <textarea name="service_add_content" class="ckeditor"></textarea>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label style="font-size: 15px;"><input type="radio" name="service_add_status" value="1" checked="" /> Aktif</label>
                                    <label style="font-size: 15px;"><input type="radio" name="service_add_status" value="0" /> Pasif</label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="file" name="service_add_photo" required="">
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
