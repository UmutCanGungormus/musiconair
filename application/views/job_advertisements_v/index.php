                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-12 col-sm-12 col-md-7 col-lg-8 col-xl-8">
                                <div class="card-body position-relative mb-5">
                                    <h5 class="card-title"><a href="<?= base_url("is-ilani/{$value->seo_url}") ?>"><?= $value->title ?></a></h5>
                                    <p class="card-text">
                                ...
                                <a class="btn btn-danger mr-0 mb-0 rounded-0 btnBottomRight" href="<?= base_url("is-ilani/{$value->seo_url}") ?>">İLAN DETAYI</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
