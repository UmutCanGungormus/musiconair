        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="breadcrumb pl-0">
                    ...
                    <a href="<?= base_url("galeriler"); ?>">Galeriler</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="card rounded-0 mb-3 <?= (get_cookie("theme", true) == "dark" ? "bg-dark" : null) ?>">
                        <div class="row no-gutters">
                            <div class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-4">
                                <a href="<?= base_url("galeri/{$value->url}") ?>"><img src="<?=get_picture("galleries_v/{$value->gallery_type}",$value->img_url) ?>" class="card-img img-fluid d-flex h-100 rounded-0" alt="<?= $value->title ?>"></a>
                            </div>
                    ...
                    <?php foreach ($most_read as $item) : ?>
                        <a href="<?= base_url("haber/{$item->seo_url}"); ?>" class="text-color">
                            <div class="card rounded-0 border mb-3 <?= (get_cookie("theme", true) == "dark" ? "bg-dark" : null) ?>">
                                <div class="row no-gutters">
                                    <div class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-4">
                                        <img src="<?=get_picture("galleries_v",$item->img_url) ?>" class="card-img img-fluid d-flex h-100 rounded-0" alt="<?= $item->title; ?>">
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-7 col-lg-8 col-xl-8">
                                        <div class="card-body">
